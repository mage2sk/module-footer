<?php
/**
 * Standalone install + heartbeat reporter for Panth_Footer.
 *
...
namespace Panth\Footer\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_Footer';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-footer';
